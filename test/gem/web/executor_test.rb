...
class ExecutorTest < Minitest::Test
  def test_should_open_the_documentation
  ...
  def test_should_open_the_homepage
  ...
  def test_should_open_rubygems_if_it_could_not_find_page
    Launchy.expects(:open).with("https://rubygems.org/gems/rails")    
